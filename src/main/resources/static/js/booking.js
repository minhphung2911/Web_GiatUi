...
function initBooking() {
    ...
    if (guestTab && userTab && guestBooking && userBooking) {
        ...
        if (user) {
            ...
            // Populate user info
            document.getElementById('user-info-name').textContent = `${user.firstName} ${user.lastName}`;
            document.getElementById('user-info-email').textContent = user.email;
            document.getElementById('user-info-phone').textContent = user.phone;
            document.getElementById('user-info-address').textContent = user.address || 'No address provided';
